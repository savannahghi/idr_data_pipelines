...
STAGING_DATASET = models.Variable.get("HTS_test")
...
with DAG('keemr_hts_transforms_test', schedule_interval='0 4 * * *', default_args=default_args) as dag:
...
listener >> deduplicate >> mfl >> dates >> entrypoint_1 >> entrypoint_2 >> entrypoint_3
